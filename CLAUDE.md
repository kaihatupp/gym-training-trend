...
3. **サマリー**: 連続記録日数(現在/自己ベスト)、週次・月次サマリー(前へ/次へで期間移動、**トレーニング記録**(記録日数・有酸素運動・筋トレ・ストレッチ)と**カロリーサマリー**(平均体重・消費カロリー合計・摂取カロリー合計・減量目安オーバー日数(運動分を加味/運動分含まずの2種類)の5項目)を分けて表示・2026-08-28に分離)、成長の横断比較(マシンごとの初回→最新の重量・回数比較表)。
